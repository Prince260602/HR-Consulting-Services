      ...
      <div className='job-list'>
        <div>
          <div className='job-list-deatils'>
            <button className=' job-list-button' onClick={() => { navigate('/jobVacancies') }} >
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none"><g id="carbon:arrow-right"><path id="Vector" d="M7.875 3.375L8.67938 4.15856L4.41563 8.4375H15.75V9.5625H4.41563L8.67938 13.8223L7.875 14.625L2.25 9L7.875 3.375Z" fill="#033658"></path></g></svg>
              Job List</button>


            <div className='job-category-name'>
              <div>{jobDataInfo?.JobList?.jobcategory}
              </div>
            </div>
            ...
            <div className='job-deatils-apply'>
              ...
              <div className='d-flex'>
                ...
                <div className=' job-degree'>{jobDataInfo?.JobList?.jobdegree}</div>
              </div>
              <div className='d-flex'>
                ...
                <div className='job-location'>{jobDataInfo?.JobList?.jobLocation}</div>
              </div>
              <div className='d-flex'>
                <svg className={`salary-icons ${!jobDataInfo?.JobList?.jobSalary.includes('to') ? 'adjust-margin' : ''}`}
                ...
                <div className='job-salary'>{jobDataInfo?.JobList?.jobSalary}</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className=' job-information-div '>
        ...
        <div className='job-information'>
          ...
          <div className='key-responsibilities'>
            {jobDataInfo?.JobList?.KeyResponsibilities && jobDataInfo.JobList.KeyResponsibilities.length > 0 && (
              <>
                <h1 className='key-responsibilities-heading'>Key Responsibilities:</h1>

                <ul>
                  {jobDataInfo?.JobList?.KeyResponsibilities?.map((responsibility, index) => (
